...
import { Fornecedor } from "@/models/Marca/Marca";
  ...
  return (
    <>
      <main className="bg-white-default p-4 w-[100%] h-dvh">
        <h1 className="mb-4 w-auto font-lexend font-bold text-4xl">
          Componentes
        </h1>
        ...
        <div className="justify-items-center gap-4 grid grid-cols-4">
          ...
          <div className="flex flex-col gap-8 col-span-4 bg-white p-4 border border-gray-default rounded-lg w-[100%]">
            ...
            <div className="w-full h-full">
              <h2 className="font-[nunito] text-(--text-secondary)">
                Botão Componente
              </h2>
              <div className="flex-wrap items-center gap-2 grid grid-cols-2">
                <Button label={"Clique aqui"} size="small" variant="outlined" />
                <Button label={"Clique aqui"} size="small" variant="filled" />
                <Button
                  label={"Clique aqui"}
                  size="default"
                  variant="outlined"
                ...
                <Button label={"Clique aqui"} size="default" variant="filled" />
              </div>
          ...
          body={
            <>
              <p>
                ...
                natus eligendi saepe delectus blanditiis nam ea ad quibusdam
                alias totam. At veritatis soluta voluptate alias porro pariatur
                magnam laborum a.
              </p>
            </>
          }
