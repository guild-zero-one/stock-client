...
export default function Select<T>({
    ...
    return (
        <div>
            <div className={`relative flex border border-gray-dark rounded focus-within:border-pink-default items-center px-4 bg-white`}>
                {/* SELECT */}
                <select
                    name={name}
                    id={name}
                    ...
                    disabled={disabled}
                    className={`peer appearance-none bg-white w-full border-none focus:outline-none pr-8 ${sizeClasses} ${disabled ? 'text-gray-400' : ''}`}
                >
