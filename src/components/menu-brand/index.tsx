...
type CategoriesMenuProps = {
  ...
  image: string;
  description: string;
  // quantity: number; // Removido por hora
  onClick?: () => void;
};
export default function CategoriesMenu({ name, image, description, onClick = () => {} }: CategoriesMenuProps) {
  return (
    <div className="flex flex-col gap-2 cursor-pointer" onClick={onClick}>
      <div className="flex flex-shrink-0 bg-white p-4 rounded-2xl w-full h-[35vh] min-h-[160px] max-h-[200px]">
        ...
        <div className="flex flex-col w-full">
          ...
          {/* Quantidade de Produtos na categoria | Removido por hora*/}
